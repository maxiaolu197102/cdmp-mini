...
cd /home/mxl/cdmp-mini/cdmp-mini && IAM_APISERVER_E2E=1 IAM_APISERVER_BASEURL=http://192.168.10.8:8088 IAM_APISERVER_ADMIN_USER=admin IAM_APISERVER_ADMIN_PASS='Admin@2021' go test ./test/iam-apiserver/user/update -count=1 -test.v -timeout 100m
./scripts/run_update_k6.sh -u https://iam.example.com -d /path/to/update_dataset.json -t <TOKEN> -- --tag test=nightly
